...
type SecurityScheme struct {
	...
	Scheme           string `json:"scheme,omitempty"`           // REQUIRED (maybe not) The name of the HTTP Authentication scheme to be used
	...
	Flows            *Flows `json:"flows,omitempty"`            // REQUIRED (maybe not) The type of flow used by the OAuth2 security scheme.
	OpenIDConnectURL string `json:"openIdConnectUrl,omitempty"` // REQUIRED (maybe not) OpenId Connect URL to discover OAuth2 configuration values. This MUST be in the form of a URL. The OAuth2 standard requires the use of TLS.
}
